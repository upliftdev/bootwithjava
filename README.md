...
- [Install Core Java](https://www.youtube.com/watch?v=yEa641gwY30)
...
### Core Java Pratice<a name="core-java-programs"></a>

- [Core Java Practice problems](https://javahungry.blogspot.com/2019/12/java-projects-for-beginners.html)

### Unit Testing With Junit<a name="unit-testing-with-junit"></a>

- [Junit](https://www.youtube.com/watch?v=2E3WqYupx7c&list=PLqq-6Pq4lTTa4ad5JISViSb2FVG8Vwa4o)

## Build with Maven<a name="build-with-maven"></a>

- [Maven-Fundamenals](https://www.youtube.com/watch?v=dqJanLvjDqc)

- [Maven-Practice](https://www.youtube.com/watch?v=uEYjXpMDJiU)

## SQL Basics<a name="sql-basics"></a>

- [SQL basics](https://www.youtube.com/watch?v=HXV3zeQKqGY)

### SQL Problem Solving<a name="sql-fun-game"></a>

- [SQL Fun Game](https://mystery.knightlab.com)

## Spring<a name="spring"></a>

- [Spring Fundamentals](https://www.youtube.com/watch?v=If1Lw4pLLEo)

- [Spring Practice](https://github.com/BNYMellon/spring-kata/tree/main/spring-framework)
